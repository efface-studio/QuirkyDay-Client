...
function PartnersSection() {
  return (
    <section className="snap-section bg-paper py-24">
      <div className="mx-auto max-w-7xl px-6">
        <Reveal>
          ...
          <p className="mt-4 max-w-xl text-sm text-ink-soft">
            ...
            만들어 가는 협력 기관들이에요. 카드를 클릭하면 공식 사이트로 이동.
          </p>
          {/* 카테고리 범례 */}
          <div className="mt-6 flex flex-wrap items-center gap-4 font-mono text-[10px] uppercase tracking-widest text-ink-mute">
            <span className="inline-flex items-center gap-2">
              <span className="h-2.5 w-2.5 rounded-full bg-magenta" /> 운영
            </span>
            <span className="inline-flex items-center gap-2">
              <span className="h-2.5 w-2.5 rounded-full bg-cyan" /> 상위 기관
            </span>
            <span className="inline-flex items-center gap-2">
              <span className="h-2.5 w-2.5 rounded-full bg-purple" /> 정책·진흥원
            </span>
            <span className="inline-flex items-center gap-2">
              <span className="h-2.5 w-2.5 rounded-full bg-lime" /> 연계 사업
            </span>
            <span className="inline-flex items-center gap-2">
              <span className="h-2.5 w-2.5 rounded-full bg-tangerine" /> 자매·협회
            </span>
          </div>
        </Reveal>
      </div>
